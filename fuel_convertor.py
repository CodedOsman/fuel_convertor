...
''' Calling UI library to set window parameters '''
window = Tk()
...
#preset supported currencies
curr_vale = ['CAD', 'GHS', 'USD', 'INR', 'GBP', 'JPY']

#label and options for currency
...
#label and text area for amount input
...
#button to do conversion by calling API function
